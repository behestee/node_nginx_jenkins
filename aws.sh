...
if ! [ -L /var/www/node_nginx_jenkins ]; then
  rm -rf /var/www/node_nginx_jenkins
  ln -fs /home/ubuntu/node_nginx_jenkins /var/www/node_nginx_jenkins
fi
...
sudo ln -s /etc/nginx/sites-available/nginx_vhost /etc/nginx/sites-enabled/nginx_vhost
...
apt-get -y clean
chown -R jenkins:www-data /home/ubuntu/node_nginx_jenkins
